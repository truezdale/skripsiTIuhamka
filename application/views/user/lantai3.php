...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <section>
                <h1 class="text-center">DAFTAR RUANGAN LANTAI 3</h1>
                <div class="mb-2">
                ...
                <div class="keywordcary" id="ruangan">
                    <form action="<?php echo base_url('user/cariLantai3'); ?>" method="post">
                ...
                <div class="keywordtanggal" id="tanggal">
                    <form action="<?php echo base_url('user/cariTanggal3'); ?>" method="post">
                        <div class="input-group mb-3">
